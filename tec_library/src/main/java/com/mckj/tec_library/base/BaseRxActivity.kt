 ...
 * @description
 */
abstract class BaseRxActivity : AppCompatActivity(),BaseRxView{
    private var disposables2Stop: CompositeDisposable? = null

    private var disposables2Destroy: CompositeDisposable? = null
